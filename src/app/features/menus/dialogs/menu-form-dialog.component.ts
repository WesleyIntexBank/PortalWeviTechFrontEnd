  ...
  template: `
    ...
    <div class="dialog-content" [formGroup]="form">
      <mat-form-field appearance="outline">
        ...
        <input matInput formControlName="title" placeholder="Ex: Usuários">
      ...
      <mat-form-field appearance="outline">
        ...
        <input matInput formControlName="url" placeholder="/users">
      ...
      <mat-form-field appearance="outline">
        ...
        <mat-select formControlName="menuId">
          <mat-option [value]="null">— Nenhum —</mat-option>
          @for (m of data.allMenus; track m.id) {
            @if (!m.isSubMenu && (!data.menu || m.id !== data.menu.id)) {
...
export class MenuFormDialogComponent {
  ...
  form = this.fb.group({
    ...
    url: [this.data.menu?.url || '', Validators.required],
    menuId: [this.data.menu?.menuId || null],
    component: [this.data.menu?.component || ''],
  });
